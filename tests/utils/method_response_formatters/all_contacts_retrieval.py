...
# All Rights Reserved.
#
# This file is part of hubspot-all_contacts
# <https://github.com/2degrees/hubspot-all_contacts>, which is subject to the
...
def _format_contact_profiles_data(contact):
    contact_profile_data = {
        'vid': contact.vid,
        'identities': [
            {'type': 'LEAD_GUID', 'value': get_random_uuid4_str()},
